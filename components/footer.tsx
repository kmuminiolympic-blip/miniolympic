            ...
            <div className="space-y-4">
              <ul className="space-y-3 text-sm text-muted-foreground font-medium">
                <li className="flex items-center gap-2">
                  <Phone className="w-4 h-4 text-emerald-600" /> 000-000-0000
                </li>
                <li className="flex items-center gap-2">
                  <Mail className="w-4 h-4 text-emerald-600" /> kmuminiolympic@gmail.com
                </li>
                <li className="flex items-start gap-2">
                  <MapPin className="w-4 h-4 text-emerald-600 mt-1" /> 대구광역시 달서구 계명대학교 체육대학
                </li>
              </ul>
